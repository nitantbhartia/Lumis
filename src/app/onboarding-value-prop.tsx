...
export default function OnboardingValuePropScreen() {
  ...
  useEffect(() => {
    ...
    hookOpacity.value = withDelay(600, withTiming(1, { duration: 400 }));
    dividerWidth.value = withDelay(800, withTiming(1, { duration: 300, easing: Easing.out(Easing.ease) }));
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={[styles.container, { paddingTop: insets.top + 40 }]}>
        <View style={styles.content}>
          ...
          {/* Hook Section */}
          <Animated.View style={[styles.hookContainer, hookStyle]}>
            <Animated.View style={[styles.divider, dividerStyle]} />
            <Text style={styles.hookText}>
              Pay <Text style={styles.hookEmphasis}>$1</Text> to stay in bed.
            </Text>
            <Text style={styles.hookSubtext}>
              Or just get up and find morning light to unlock your apps.
            </Text>
          </Animated.View>
        </View>
